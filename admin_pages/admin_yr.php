...
<html>
    <head>
        ...
        <title>NeoTones - Last Yearly Sales</title>
    ...
    <?php
        echo "<h1 align=left>Total Sales - Last 365 Days</h1>";
                    ...
                    $sql = "SELECT purchaseID,Artist_Name, COUNT(purchaseID) AS `value_occurrence` FROM `purchased_works` WHERE `date` BETWEEN CURRENT_DATE-365 AND CURRENT_DATE GROUP BY Artist_Name ORDER BY `value_occurrence` DESC LIMIT 1;";
