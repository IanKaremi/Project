...
<html>
    ...
    <?php
        echo "<h1 align=left>Total Sales - All Time</h1>";
                    ...
                    $sql = "SELECT purchaseID, Artist_Name, COUNT(purchaseID) AS `value_occurrence` FROM `purchased_works` GROUP BY Artist_Name ORDER BY `value_occurrence` DESC LIMIT 1;";
